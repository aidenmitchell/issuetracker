...
function App() {
  return (
    <div className="App p-4 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen">
      ...
      <p className="mb-4 mt-2 italic dark:text-gray-400">Best viewed in landscape on mobile devices. | "Issue importance" is a subjective judgement made by the author.</p>
